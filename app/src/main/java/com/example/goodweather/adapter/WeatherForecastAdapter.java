...
public class WeatherForecastAdapter extends BaseQuickAdapter<WeatherForecastBean.HeWeather6Bean.DailyForecastBean, BaseViewHolder> {

    public WeatherForecastAdapter(int layoutResId, @Nullable List<WeatherForecastBean.HeWeather6Bean.DailyForecastBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, WeatherForecastBean.HeWeather6Bean.DailyForecastBean item) {
