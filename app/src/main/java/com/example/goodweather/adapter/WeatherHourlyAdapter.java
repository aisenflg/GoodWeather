...
public class WeatherHourlyAdapter extends BaseQuickAdapter<HourlyBean.HeWeather6Bean.HourlyData, BaseViewHolder> {
    public WeatherHourlyAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<HourlyBean.HeWeather6Bean.HourlyData> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HourlyBean.HeWeather6Bean.HourlyData item) {
