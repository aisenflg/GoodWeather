...
public class MoreDailyAdapter extends BaseQuickAdapter<DailyResponse.DailyBean,BaseViewHolder> {
    ...
    public MoreDailyAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<DailyResponse.DailyBean> data) {
    ...
    private String uvIndexToString(String uvIndex) {//最弱(1)、弱(2)、中等(3)、强(4)、很强(5)
        String result = null;
        switch (uvIndex) {
            case "1":
                result = "最弱";
