 ...
 * 添加城市时搜索返回结果列表适配器
 */
public class CommonlyCityAddAdapter extends BaseQuickAdapter<SearchCityBean.HeWeather6Bean.BasicBean, BaseViewHolder> {
    private String edStr;//关键字

    public CommonlyCityAddAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<SearchCityBean.HeWeather6Bean.BasicBean> data) {
